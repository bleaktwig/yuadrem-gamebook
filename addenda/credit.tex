...
\subsection*{Yuadrem}
    ...
    \subparagraph{Nyx} The image used for Nyx is stolen from ``Mythic Odysseys of Theros'', as many other images used from this point onward.
...
\subsection*{Viphoger}
    The whole Viphoger region is a re-skin of Theros, and the chapter itself is essentially a copy of the third chapter of ``Mythic Odysseys of Theros''.
...
\subsection*{Classless D\&D}
    ...
    \subparagraph{Proficiency Feats} Many feats and items related to proficiencies were inspired by or directly taken from \href{https://dumpstatadventures.com/}{Dump Stat Adventures} and \href{https://growupandgame.com/dungeons-and-dragons/questionable-arcana/dnd-5e-crafting-glassblowers-tools/}{Grow Up and Game}.
...
\subsection*{Spellcasting}
    ...
    \subparagraph{Frithbinding} Frithlings in general are heavily inspired by Chwingas from WotC.
