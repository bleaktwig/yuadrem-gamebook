...
\begin{table*}[b]%
    \begin{DndTable}[width=\linewidth, header=General Talents]{clXX} \label{feat::generaltalents}
...
\begin{table*}[b]%
    \begin{DndTable}[width=\linewidth, header=Kin Talents]{clXX} \label{feat::kintalents}
        \textbf{Page} & \textbf{Name} & \textbf{Tags} & \textbf{Requirements} \\
    \end{DndTable}
\end{table*}
...
\begin{table*}[b]%
    \begin{DndTable}[width=\linewidth, header=Artisan Talents]{clXX}
        \textbf{Page} & \textbf{Name} & \textbf{Tags} & \textbf{Requirements} \\
    \end{DndTable}
\label{feat::artisantalents}
\end{table*}

\begin{table*}[b]%
    \begin{DndTable}[width=\linewidth, header=Injury Talents]{clXX} \label{feat::injurytalents}
        \textbf{Page} & \textbf{Name} & \textbf{Tags} & \textbf{Requirements} \\
    \end{DndTable}
\end{table*}
...
\subsubsection{Dementia Insight} \label{feat::dementiainsight}
\small{\textcolor{gray}{-}}
