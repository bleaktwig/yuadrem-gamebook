...
\begin{table*}[b]%
    \begin{DndTable}[width=\linewidth]{X}
        \centering
        \includegraphics[width=0.95\textwidth]{01intro/img/12dead_sea.png} \
        \centering \large{\textbf{The Bone Cliffs of the Dead Sea}}
    \end{DndTable}
\end{table*}

\subsection*{The Three Deserts}
...
% Along with the tortles, grungs, and umans, the Schism brought forth terrible creatures known as the blueblood beasts.
