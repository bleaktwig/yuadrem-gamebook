...
\subsubsection{Similarity Link}
    ...
    \DndSpellHeader{Cosanguinity I: NAME \label{spell::name}}
    ...
    \DndSpellHeader{Cosanguinity II: NAME \label{spell::name}}
        {Sympathy spell - x spell points}
        {n actions}
        {30 meters}
        {COMPONENTS}
    ...
    \DndSpellHeader{Wave I: NAME \label{spell::name}}
        {Sympathy spell - x spell points}
        {n actions}
        {24 meters}
        {COMPONENTS}
        ...
        EXTRA EFFECT 1
        EXTRA EFFECT 2 (+1 ACTION)
    \DndSpellHeader{Wave II: NAME \label{spell::name}}
        {Sympathy spell - x spell points}
        {n actions}
        {30 meters}
        {COMPONENTS}
