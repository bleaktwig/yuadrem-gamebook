...
\subsection*{Mediums}
    ...
    \DndSpellHeader{Similarity Link: Tether \label{spell::tether}}
        ...
        \begin{itemize}
            ...
            \item \textbf{Harm}.
            You trace a sigil of harming.
            Any time one of the linked creatures takes damage, all other creatures take 1d4 force damage (roll once for all creatures).
            \item \textbf{Ward}.
            You trace a sigil of warding.
