...
\subsection*{Traits}
    ...
    As two actions, you can eject spores at one creature you can see within 1.5 meters of you.
    ...
    \textbf{Enhanced Spores} (page \pageref{feat::enhancedspores}),
    \textbf{Fungal Abode} (page \pageref{feat::fungalabode}),
    \textbf{Fungal Body} (page \pageref{feat::fungalbody}),
    \textbf{Mycelium Connection} (page \pageref{feat::myceliumconnection}),
    \textbf{Nature's Sanctuary} (page \pageref{feat::naturessanctuary}),
    \textbf{Symbiotic Entity} (page \pageref{feat::symbioticentity}), and
    \textbf{Strong Telepathy} (page \pageref{feat::strongtelepathy}).
...
\subsubsection{Gannagian Tsanek}
    ...
    \textbf{Balm of Dreams} (page \pageref{feat::balmofdreams}),
    \textbf{Fungal Infestation} (page \pageref{feat::fungalinfestation}), and
    \textbf{Narcotic Empowerement} (page \pageref{feat::narcoticempowerement}).
...
\subsubsection{Na'anian Tsanek}
    ...
    \subparagraph{Feats} From your subrace, the feats available to you are
    \textbf{Benign Growths} (page \pageref{feat::benigngrowths}),
