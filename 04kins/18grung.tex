...
\subsection*{Traits}
    ...
    \textbf{Gold Toxin} (page \pageref{feat::goldtoxin}),
    \textbf{Hardy} (page \pageref{feat::hardy}),
    \textbf{Mesmerizing Chirr} (page \pageref{feat::mesmerizingchirr}),
    \textbf{Mirthful Leaps} (page \pageref{feat::mirthfulleaps}),
    \textbf{Moist Skin} (page \pageref{feat::moistskin}),
    \textbf{Poison Immunity} (page \pageref{feat::poisonimmunity}),
    \textbf{Slippery Skin} (page \pageref{feat::slipperyskin}),
    \textbf{Toxic Skin} (page \pageref{feat::toxicskin}), and
    \textbf{Waterbound} (page \pageref{feat::waterbound}).
