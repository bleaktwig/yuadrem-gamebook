...
\subsubsection{Moonborn}
    ...
    \subparagraph{Moon Magic} You know the Light spell, which you can freely cast.
    When you reach third level, you learn the \textbf{Faerie Fire} spell, which you can cast once per day.
