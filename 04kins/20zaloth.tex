...
\subsubsection{Gale Zaloth}
    ...
    \subparagraph{Wind Given Form} You know the \textbf{Gust} spell (page \pageref{spell::gust}), which you can use freely.
    Once you reach 3rd level, you can cast the \textbf{Feather Fall} spell (page \pageref{spell::featherfall}) once per day.
...
\subsubsection{Thunder Zaloth}
    ...
    \subparagraph{Electricity Given Form} You know the \textbf{Shocking Grasp} spell (page \pageref{spell::shockinggrasp}), which you can use freely.
...
\subsubsection{Ash Zaloth}
    ...
    \subparagraph{Flame Given Form} You know the \textbf{Produce Flame} spell (page \pageref{spell::produceflame}), which you can use freely.
    Once you reach 3rd level, you can cast the \textbf{Burning Hands} spell (page \pageref{spell::burninghands}) once per day.
    Once you reach 5th level, you can cast the \textbf{Aganazzar's Scorcher} spell (page \pageref{spell::aganazzarsscorcher}) once per day.
    Charisma is your spellcasting ability for these spells.
...
\subsubsection{Hail Zaloth}
    ...
    \subparagraph{Ice Given Form} You know the \textbf{Frostbite} spell (page \pageref{spell::frostbite}), which you can use freely.
