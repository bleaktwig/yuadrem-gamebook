% !TEX root = ../main.tex
\section{Nomad Kin} \label{sec::nomadkin}
...
Brought into this world with the Schism, the nomad kin are a strange race from the Underworld.
...
Umans pay dearly for this special blood, as it acts as a beacon for the predators from the Underworld, the coldblood beasts.
...
These communities keep their locations secret, communicating it only to other umans via traveller's cant, a set of writings and symbols they brought from the Underworld.
...
Even in the Underworld, umans were known to have a great variety of names depending on each specific culture.
