...
\subsection*{Traits}
    ...
    \textbf{Cower} (page \pageref{feat::cower}),
    ...
    \textbf{Protected but Dangerous} (page \pageref{feat::protectedbutdangerous}),
    \textbf{Purity of Body} (page \pageref{feat::purityofbody}),
    \textbf{Reptile Claws} (page \pageref{feat::reptileclaws}),
    \textbf{Reveler} (page \pageref{feat::reveler}),
    \textbf{Steam Breath} (page \pageref{feat::steambreath}), and
