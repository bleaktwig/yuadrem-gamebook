...
\subsection*{Fagal Affinity}
    \DndSpellHeader{Fagal Affinity: Volatilize \label{medium::volatilize}}
        ...
        {DURATION}
        DESCRIPTION
    \DndSpellHeader{SPELL I: Ensnaring Strike \label{spell::ensnaringstrike}}
        {Alchemy spell - 2 spell points}
        {1/2 action}
        {Self}
        {V}
    ...
    \DndSpellHeader{SPELL I: Acid Arrow \label{spell::acidarrow}}
        {Alchemy spell - 3 spell points}
        {2/3 actions}
        {18 meters}
    ...
    \DndSpellHeader{SPELL I: Minute Meteors \label{spell::minutemeteors}}
        {Alchemy spell - 5 spell points}
        {2 actions}
        {Touch}
    ...
    \DndSpellHeader{SPELL II: Crown of Stars \label{spell::crownofstars}}
        {Alchemy spell - 10 spell points}
        {2 actions}
        {Touch}
        {V, S}
    ...
    \DndSpellHeader{SPELL I: Magic Missile \label{spell::magicmissile}}
        {Alchemy spell - 2 spell points}
        {2 actions}
        {24 meters}
        {V, S}
    ...
    \DndSpellHeader{SPELL II: Counterspell \label{spell::counterspell}}
        {Alchemy spell - 5 spell points}
    ...
    \DndSpellHeader{SPELL I: Kruphix's Mockery \label{spell::kruphixsmockery}}
        {Alchemy spell - 6 spell points}
        {1 minute}
        {6 meters}
        {V, S, M (a small stone)}
    ...
    \DndSpellHeader{SPELL II: Death Ward \label{spell::deathward}}
        {Alchemy spell - 6 spell points}
        {2/3 actions}
        {Touch}
        {V, S}
    ...
    \DndSpellHeader{SPELL I: Continual Flame \label{spell::continualflame}}
        {Alchemy spell - 2 spell points}
        {2 actions}
        {Touch}
    ...
    \DndSpellHeader{SPELL II: Sickening Radiance \label{spell::sickeningradiance}}
        {Alchemy spell - 6 spell points}
        {2/3 actions}
    ...
    \DndSpellHeader{SPELL I: Inflict Wounds \label{spell::inflictwounds}}
        {Alchemy spell - 2 spell points}
        {2 actions}
        {Touch}
        {V, S}
        ...
        Constructs are immune to this effect.
    \DndSpellHeader{SPELL II: Vampiric Touch \label{spell::vampirictouch}}
        {Alchemy spell - 5 spell points}
        {2/3 actions}
        {Touch}
        {V, S}
    ...
    \DndSpellHeader{SPELL II: Harm \label{spell::harm}}
        {Alchemy spell - 9 spell points}
        {2 actions}
        {24 meters}
        {V, S}
    ...
    \DndSpellHeader{SPELL II: Horrid Wilting \label{spell::horridwilting}}
        {Alchemy spell - 11 spell points}
        {2 actions}
        {6-meter cube}
    ...
    \DndSpellHeader{SPELL I: Shadow Weapon \label{spell::shadoweapon}}
        {Alchemy spell - 3 spell points}
        {1 action}
        {Touch}
        {V, S}
    ...
    \DndSpellHeader{SPELL II: Ukarilth's Staff \label{spell::ukarilthsstaff}}
        {Alchemy spell - 10 spell points}
        {2 actions}
        {Touch}
