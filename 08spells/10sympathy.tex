...
\subsection*{Heat Link}
    ...
    \DndSpellHeader{I: Fog Cloud \label{spell::fogcloud}}
    ...
    \DndSpellHeader{II: Steam Burst \label{spell::steamburst}}
    ...
    \DndSpellHeader{I: Frostbite \label{spell::frostbite}}
        {Sympathy spell - 2 spell points}
        {2 actions}
        {24 meters}
        {S, M (a snowflake)}
    ...
    \DndSpellHeader{II: Freezing Sphere \label{spell::freezingsphere}}
    ...
    \DndSpellHeader{I: Fireball \label{spell::fireball}}
    ...
    \DndSpellHeader{II: Fire Storm \label{spell::firestorm}}
    ...
    \DndSpellHeader{I: Heat Metal \label{spell::heatmetal}}
        {Sympathy spell - 3 spell points}
        {2 actions}
        {24 meters}
    ...
    \DndSpellHeader{II: Immolation \label{spell::immolation}}
    ...
    \DndSpellHeader{I: Light \label{spell::light}}
    ...
    \DndSpellHeader{II: Brilliance \label{spell::brilliance}}
        {Sympathy spell - 5 spell points}
        {1 actions}
        {30 meters}
        {V, S}
    ...
    \DndSpellHeader{I: Scold \label{spell::scold}}
        {Sympathy spell - 2 spell points}
    ...
    \DndSpellHeader{II: Fire Shield \label{spell::fireshield}}
    ...
    \DndSpellHeader{I: Searing Smite \label{spell::searingsmite}}
        {Sympathy spell - 2 spell points}
        {1 action}
        {24 meters}
        {V}
    ...
    \DndSpellHeader{II: Flame Arrows \label{spell::flamearrows}}
        {Sympathy spell - 5 spell points}
        {2 actions}
        {24 meters}
    ...
    \DndSpellHeader{I: Burn Wounds \label{spell::burnwounds}}
        {Sympathy spell - 2 spell points}
        {2 actions}
        {24 meters}
    ...
    \DndSpellHeader{II: Aura of Vitality \label{spell::auraofvitality}}
        {Sympathy spell - 5 spell points}
        {2 actions}
        {30 meters}
        {V, S}
...
\subsection*{Electric Link}
    \DndSpellHeader{Electric Link: Charge \label{medium::charge}}
        ...
        \begin{itemize}
            ...
            Objects automatically roll a number equal to their weight (in kg) divided by 5.
        \end{itemize}
    \DndSpellHeader{I: Stride \label{spell::stride}}
        {Sympathy spell - 2 spell points}
        {1 action}
        {24 meters}
        {V, S}
    ...
    \DndSpellHeader{II: Haste \label{spell::haste}}
        {Sympathy spell - 5 spell points}
        {2 actions}
        {30 meters}
        {V, S}
    ...
    \DndSpellHeader{I: Lightning Bolt \label{spell::lightningbolt}}
        {Sympathy spell - 5 spell points}
        {2 actions}
        {20-meter line}
        {V, S}
    ...
    \DndSpellHeader{II: Chain Lightning \label{spell::chainlightning}}
        {Sympathy spell - 9 spell points}
        {2 actions}
        {30 meters}
        {V, S}
    ...
    \DndSpellHeader{I: Deflect \label{spell::deflect}}
        {Sympathy spell - 2 spell points}
    ...
    \DndSpellHeader{II: Eject \label{spell::eject}}
        {Sympathy spell - 5 spell points}
        {2 actions}
    ...
    \DndSpellHeader{I: Call Lightning \label{spell::calllightning}}
        {Sympathy spell - 5 spell points}
        {2 actions}
        {24 meters}
        {V, S}
    ...
    \DndSpellHeader{II: Storm Sphere \label{spell::stormsphere}}
        {Sympathy spell - 6 spell points}
        {2 actions}
        {30 meters}
        {V, S}
    ...
    \DndSpellHeader{I: Thunderwave \label{spell::thunderwave}}
        {Sympathy spell - 2 spell points}
        {2 actions}
    ...
    \DndSpellHeader{II: Lightning Arrow \label{spell::lightningarrow}}
        {Sympathy spell - 5 spell points}
        {1 action}
        {12 meters}
        {V, S}
    ...
    \DndSpellHeader{I: Spray \label{spell::spray}}
        {Sympathy spell - 2 spell points}
        {2 actions}
        {Self (3-meter cone)}
        {V, S}
    ...
    \DndSpellHeader{II: Hold \label{spell::hold}}
        {Sympathy spell - 7 spell points}
        {2 actions}
        {30 meters}
        {V, S}
    ...
    \DndSpellHeader{I: Booming Blade \label{spell::boomingblade}}
        {Sympathy spell - 0 spell points}
        {1 action}
        {12 meters}
        {V}
    ...
    \DndSpellHeader{II: Electric Arc \label{spell::electricarc}}
        {Sympathy spell - 0 spell points}
        {2 actions}
        {3 meters}
        {V, S}
        ...
        The creature takes 1d8 lightning damage plus an extra 1d8 lightning damage for each charge lost in this way.
        This effect's base damage increases by 1d8 when you reach 5th level (2d8), 11th level (3d8), and 17th level (4d8).
    \DndSpellHeader{I: Misty Step \label{spell::mistystep}}
        {Sympathy spell - 3 spell points}
        {1 actions}
        {Self meters}
        {V}
    ...
    \DndSpellHeader{II: Thunder Step \label{spell::thunderstep}}
        {Sympathy spell - 5 spell points}
        {2 actions}
        {18 meters}
        {V}
...
\subsection*{Similarity Link}
    \DndSpellHeader{Similarity Link: Tether \label{medium::tether}}
        ...
        \end{itemize}
    \DndSpellHeader{I: Sinkhole \label{spell::sinkhole}}
        {Sympathy spell - 6 spell points}
        {2 actions}
        {24 meters}
        {S, M (a piece of rock)}
    ...
    \DndSpellHeader{II: Ravenous Void \label{spell::ravenousvoid}}
    ...
    \DndSpellHeader{I: Aqueous Form \label{spell::aqueousform}}
        {Sympathy spell - 5 spell points}
        {2 actions}
        {24 meters}
        {S, M (a pint of water)}
    ...
    \DndSpellHeader{II: Investiture \label{spell::investiture}}
        {Sympathy spell - 9 spell points}
        {2 actions}
        {30 meters}
    ...
    \DndSpellHeader{I: Locate \label{spell::locate}}
        {Sympathy spell - 3 spell points}
        {2 actions}
        {---}
    ...
    \DndSpellHeader{II: Effigy \label{spell::effigy}}
        {Sympathy spell - 5 spell points}
        {1 action}
        {12 meters}
    ...
    \DndSpellHeader{I: Catapult \label{spell::catapult}}
        {Sympathy spell - 2 spell points}
        {1 action}
        {24 meters}
        {S}
    ...
    \DndSpellHeader{II: Remote Movement \label{spell::remotemovement}}
        {Sympathy spell - 7 spell points}
        {2 actions}
        {30 meters}
        {S}
    ...
    \DndSpellHeader{I: Pulse Wave \label{spell::pulsewave}}
        {Sympathy spell - 5 spell points}
        {2 actions}
        {Self (6-meter cone)}
        {S}
    ...
    \DndSpellHeader{II: Radiating Pressure \label{spell::radiatingpressure}}
        {Sympathy spell - 7 spell points}
        {2 actions}
        {Self (6-meter radius)}
        {S}
    ...
    \DndSpellHeader{I: Faerie Fire \label{spell::faeriefire}}
        {Sympathy spell - 2 spell points}
        {2 actions}
        {24 meters}
        {S}
    ...
    \DndSpellHeader{II: Wall of Light \label{spell::walloflight}}
        {Sympathy spell - 7 spell points}
        {2 actions}
        {30 meters}
        {S}
    ...
    \DndSpellHeader{I: Shared Essence \label{spell::sharedessence}}
        {Sympathy spell - 6 spell points}
        {2 actions}
        {24 meters}
        {V, S}
    ...
    \DndSpellHeader{II: Life Ceding \label{spell::lifeceding}}
        {Sympathy spell - 7 spell points}
        {2 actions}
        {30 meters}
        {S, M (a drop of blood)}
    ...
    \DndSpellHeader{I: Feather Fall \label{spell::featherfall}}
        {Sympathy spell - 2 spell points}
    ...
    \DndSpellHeader{II: Adjust Density \label{spell::adjustdensity}}
        {Sympathy spell - 0 spell points}
        {2 actions}
        {30 meters}
        {S}
