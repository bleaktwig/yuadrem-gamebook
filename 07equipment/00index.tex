...
\section*{Items} \label{sec::items}
    ...
    \input{07equipment/10clothing}
    \input{07equipment/10fooddrinkandlodging}
    \input{07equipment/10mounts}
    \input{07equipment/10poisons}
    \input{07equipment/10potions}
    \input{07equipment/10spellcastergear}
    \input{07equipment/10toolsandkits}
    \input{07equipment/10treasure}
    \input{07equipment/10vehiclesandharnesses}
    \input{07equipment/10weapons}
    \input{07equipment/10wondrousitems}
