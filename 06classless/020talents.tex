...
SCHOLAR 4?/4
    \subsubsection{Scholar: Library Access} \label{feat::libraryaccess}
    ...
    \subsubsection{Scholar: Adept Linguist} \label{feat::adeptlinguist}
    \small{\textcolor{gray}{History}}
    ...
    \subsubsection{Scholar: Historical Knowledge} \label{feat::historicalknowledge}
    \small{\textcolor{gray}{History}}
    ...
    \subsubsection{Scholar: Legalese} \label{feat::legalese}
    \small{\textcolor{gray}{History or Persuasion}}
...
ARTISAN 2/4
    \subsubsection{Artisan: Urban Infrastructure} \label{feat::urbaninfrastructure}
    \small{\textcolor{gray}{?}}
    ...
    Your access to such information isn't unlimited.
    ...
    \subsubsection{Artisan: } \label{feat::NAME}
    \small{\textcolor{gray}{?}}
...
CRIMINAL 1/4
    \subsubsection{Criminal: } \label{feat::NAME}
    \small{\textcolor{gray}{?}}
...
MERCHANT 1/4
    \subsubsection{Merchant: } \label{feat::NAME}
    ...
    \subsubsection{Merchant: Down Low} \label{feat::downlow}
    \small{\textcolor{gray}{Persuasion}}

    \normalsize
    You are acquainted with a network of smugglers who are willing to help you out of tight situations.
    While in a particular town, city, or other similarly sized community (DM's discretion), you and your companions can stay for free in safe houses.
    ...
    \subsubsection{Merchant: Guild Membership} \label{feat::guildmembership}
    \small{\textcolor{gray}{Persuasion}}
