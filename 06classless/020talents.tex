...
% One required 2 TP, and is a lv 6 ability from a related class.
% Two are shared with other classes, and are considered outside of the rules previously mentioned, but must only need 1 TP.
...
ACOLYTE 4/4, 1/2
    ...
    \subsubsection{Divine Healing (2 TP)} \label{feat::divinehealing}
...
ENTERTAINER 4/4, 2/2
    ...
    \subsubsection{Jack of All Trades (2 TP)} \label{feat::jackofalltrades}
        You can add a bonus equal to 1/5 of your level, rounded up, to any ability check with which you are not already proficient.
        \paragraph{REQUIREMENTS} Entertainer background.
    % ========================================================================== %
