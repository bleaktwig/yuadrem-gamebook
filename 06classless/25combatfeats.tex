...
\subsubsection{Parrying Stance (2 FP)} \label{feat::parryingstance}
    ...
    In addition, you can assume a parrying stance using an action.
    You gain a +2 bonus to AC until the start of your next turn or until you're not holding a weapon.
    You can also use the Parry reaction without expending your reaction while in this stance.
    \paragraph{Requirements} Skilled proficiency with Curved Swords.
\subsubsection{NAME} \label{feat::name}
    DESCRIPTION
