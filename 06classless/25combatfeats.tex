...
\subsubsection{NAME} \label{feat::name}
    DESCRIPTION
    \paragraph{Requirements} Wearing armor with the Bulwark property.
\subsubsection{NAME} \label{feat::name}
    DESCRIPTION
    \paragraph{Requirements} Wearing armor with the Bulwark property.
\subsubsection{NAME (2 FP)} \label{feat::name}
...
\subsubsection{NAME} \label{feat::name}
    DESCRIPTION
    \paragraph{Requirements} Wearing armor with the Chain property.
\subsubsection{NAME} \label{feat::name}
    DESCRIPTION
    \paragraph{Requirements} Wearing armor with the Chain property.
\subsubsection{NAME (2 FP)} \label{feat::name}
...
\subsubsection{NAME} \label{feat::name}
    DESCRIPTION
    \paragraph{Requirements} Wearing armor with the Cloth property.
\subsubsection{NAME} \label{feat::name}
    DESCRIPTION
    \paragraph{Requirements} Wearing armor with the Cloth property.
\subsubsection{NAME (2 FP)} \label{feat::name}
...
\subsubsection{NAME} \label{feat::name}
    DESCRIPTION
    \paragraph{Requirements} Wearing armor with the Composite property.
\subsubsection{NAME} \label{feat::name}
    DESCRIPTION
    \paragraph{Requirements} Wearing armor with the Composite property.
\subsubsection{NAME (2 FP)} \label{feat::name}
...
\subsubsection{NAME} \label{feat::name}
    DESCRIPTION
    \paragraph{Requirements} Wearing armor with the Leather property.
\subsubsection{NAME} \label{feat::name}
    DESCRIPTION
    \paragraph{Requirements} Wearing armor with the Leather property.
\subsubsection{NAME (2 FP)} \label{feat::name}
...
% \subsubsection{NAME} \label{feat::name}
%     DESCRIPTION
%     \paragraph{Requirements} Wearing armor with the Noisy property.
% \subsubsection{NAME} \label{feat::name}
%     DESCRIPTION
%     \paragraph{Requirements} Wearing armor with the Noisy property.
% \subsubsection{NAME (2 FP)} \label{feat::name}
...
\subsubsection{NAME} \label{feat::name}
    DESCRIPTION
    \paragraph{Requirements} Wearing armor with the Plate property.
\subsubsection{NAME} \label{feat::name}
    DESCRIPTION
    \paragraph{Requirements} Wearing armor with the Plate property.
\subsubsection{NAME (2 FP)} \label{feat::name}
...
% === SHIELD TYPES =================================================================================
% SMALL SHIELDS
\subsubsection{Small Shields Proficiency} \label{feat::name}
    DESCRIPTION
\subsubsection{NAME} \label{feat::name}
    DESCRIPTION
...
% === MARTIAL WEAPONS ==============================================================================
% AXES
\subsubsection{Axes Proficiency} \label{feat::name}
    DESCRIPTION
\subsubsection{NAME} \label{feat::name}
    DESCRIPTION
...
\subsubsection{NAME (2 FP)} \label{feat::name}
    ...
    \paragraph{Requirements} Expert proficiency with Axes.
% BOWS
\subsubsection{Bows Proficiency} \label{feat::name}
    DESCRIPTION
\subsubsection{NAME} \label{feat::name}
    DESCRIPTION
...
\subsubsection{NAME (2 FP)} \label{feat::name}
    ...
    \paragraph{Requirements} Expert proficiency with Crossbows.
% CURVED SWORDS
\subsubsection{Curved Swords Proficiency} \label{feat::name}
    DESCRIPTION
\subsubsection{NAME} \label{feat::name}
    DESCRIPTION
...
\subsubsection{NAME (2 FP)} \label{feat::name}
    ...
    \paragraph{Requirements} Expert proficiency with Curved Swords.
% HAMMERS
\subsubsection{Hammers Proficiency} \label{feat::name}
    DESCRIPTION
\subsubsection{NAME} \label{feat::name}
    DESCRIPTION
...
\subsubsection{NAME (2 FP)} \label{feat::name}
    ...
    \paragraph{Requirements} Expert proficiency with Polearms.
% RAPIERS
\subsubsection{Rapiers Proficiency} \label{feat::name}
    DESCRIPTION
\subsubsection{NAME} \label{feat::name}
    DESCRIPTION
...
%     \paragraph{Requirements} Expert proficiency with Spears.
% SWORDS
\subsubsection{Straight Swords Proficiency} \label{feat::name}
    DESCRIPTION
\subsubsection{NAME} \label{feat::name}
    DESCRIPTION
...
\subsubsection{NAME} \label{feat::name}
    DESCRIPTION
    \paragraph{Requirements} Fighting Style: Superior Technique 1.
\subsubsection{NAME - ACTION} \label{feat::name}
    DESCRIPTION - UPGRADABLE
    \paragraph{Requirements} Fighting Style: Superior Technique 1.
\subsubsection{NAME (2 FP)} \label{feat::name}
...
\subsubsection{NAME} \label{feat::name}
    DESCRIPTION
    \paragraph{Requirements} Fighting Style: Superior Technique 2.
\subsubsection{NAME - ACTION} \label{feat::name}
    DESCRIPTION - UPGRADABLE
    \paragraph{Requirements} Fighting Style: Superior Technique 2.
\subsubsection{NAME (2 FP)} \label{feat::name}
