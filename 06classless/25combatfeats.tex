...
% === ARMOR TYPES ==================================================================================
% UNARMORED fortitudeofbody unarmoredagility unarmoredmaster uncannydodge
...
% LIGHT lightarmormaster lightlyarmored lightonyourfeet uncannydodge uncertainlocation
...
\subsubsection{Light Armor Master (2 FP)} \label{feat::lightarmormaster}
    ...
    \paragraph{Requirements} Proficiency with Light Armor.
% MEDIUM agileinasuit balanceddefense moderatelyarmored silentdespiteeverything vitalprotection
...
% === SIMPLE WEAPONS ===============================================================================
% SIMPLE WEAPONS adaptablefighter combatimproviser cutthroat dexteroushand quickaction simplefighter solidstart
...
% BOWS bowmaster coveredshooter hordebreaker quickshot stillaim suddenattack volley
...
\subsubsection{Volley (2 FP)} \label{feat::volley}
    ...
    \paragraph{Requirements} Expert proficiency with Bows.
% CROSSBOWS crossbowenthusiast modernshooter preparedshot puncturewound suddenattack quickloading visceralattack
...
\subsubsection{Visceral Attack (2 FP)} \label{feat::visceralattack}
    ...
    \paragraph{Requirements} Expert proficiency with Crossbows.
% CURVED SWORDS bentblademaster gracefuldisarm impairingattack mincedmeat parryingstance shieldsweep whirlwindattack
...
% HAMMERS armorbreaker bendmetal bluntfighter rush heavyhitter lowerthatguard mashedbrain
...
% POLEARMS farthrusts notonmywatch polearmmaster rondelhit sweep trip unapproachable
...
\subsubsection{Focus Attacks (2 FP)} \label{feat::focusattacks}
    ...
    \paragraph{Requirements} Expert proficiency with Rapiers.
% SWORDS classicdefense deflection frenziedslashes parryingstance revenantblade stalwartstance swordmaster
...
% === WEAPON TYPES =================================================================================
% BLUDGEONING bonk crusher fellhand offbalance
...
% PIERCING criticalinjury effectivepuncture piercer stabalung
...
% SLASHING aimedcut quickslashes slasher sustainedimpetus
...
% ARCHERY bullseye mark recklessshot sharpshooter shooter supernaturalaccuracy
...
\subsubsection{Shooter (2 FP)} \label{feat::shooter}
    ...
    \paragraph{Requirements} Fighting Style: Archery 2.
% DUELING bastion execute fightersresilience heightenedsenses improvedcritical purposefulstrike
...
\subsubsection{Fighter's Resilience (2 FP)} \label{feat::fightersresilience}
    ...
    \paragraph{Requirements} Fighting Style: Dueling 2.
% GREAT WEAPON FIGHTING cleaving improvedcritical recklessattack savageattacker superiorcritical takenaback
...
\subsubsection{Superior Critical (2 FP)} \label{feat::superiorcritical}
    ...
    \paragraph{Requirements} Fighting Style: Great Weapon Fighting 2.
% MONASTIC FIGHTING agilegrappler blindfighter flurryofblows martialartist monkeysfist quickenedhealing
...
\subsubsection{Quickened Healing (2 FP)} \label{feat::quickenedhealing}
    ...
    \paragraph{Requirements} Fighting Style: Monastic Fighting 2.
% MOUNTED FIGHTING charger heightsuperiority protectedmount strikeapose trainedmount trample
...
\subsubsection{Height Superiority (2 FP)} \label{feat::heightsuperiority}
    ...
    \paragraph{Requirements} Fighting Style: Mounted Fighting 2.
% PROTECTION auraofprotection courageousvisage durable interception protector sentinel
...
\subsubsection{Protector (2 FP)} \label{feat::protector}
    ...
    \paragraph{Requirements} Fighting Style: Protection 2.
% THROWN WEAPON FIGHTING bullseye deflectmissiles fastfingers opportunist quickdraw throwingarm
...
\subsubsection{Opportunist (2 FP)} \label{feat::opportunist}
    ...
    \paragraph{Requirements} Fighting Style: Thrown Weapons Fighting 2.
% TWO-WEAPON FIGHTING crowdbreaker dualwielder lock offenseanddefense readyforaction twoweaponmaster
...
\subsubsection{Two-weapon Master (2 FP)} \label{feat::twoweaponmaster}
    ...
    \paragraph{Requirements} Fighting Style: Two-Weapon Fighting 2.
% UNARMED FIGHTING charger grappler meathammer meatshield pugilist unarmedartist
...
\subsubsection{Meat Hammer (2 FP)} \label{feat::meathammer}
    ...
    \paragraph{Requirements} Fighting Style: Unarmed Fighting 2.
% BATTLE MASTERY actionsurge assessthesituation commander dynamicfighter mageslayer secondwind
...
% FLAILS downyougo flailadept shieldsweep steelresolve
...
% NETS fisher reel snatcher strengthenednets
...
% WHIPS extendedreach flagellation whipmaster wraparound
...
%     If you or a creature you can see within 1.5 meters of you is hit by an attack, you use your reaction to switch places with the creature, receiving the attack instead.
%
