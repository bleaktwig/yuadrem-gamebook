...
\subsubsection{Last Resort} \label{feat::lastresort}
    ...
    In addition, immediately after you use your \textbf{Relentless Endurance} trait, you can use your reaction to make one weapon attack.
    \paragraph{Requirements} Uman kin.
...
\subsubsection{Adaptable} \label{feat::adaptable}
    ...
    \paragraph{Requirements} Common Uman subrace.
...
\subsubsection{Long-Limbed (2 FP)} \label{feat::longlimbed}
    ...
    \paragraph{Requirements} Quies kin.
% QUIES OPERATIVE designedwithapurpose fleetoffoot
...
% QUIES SLAG WORKER flamesoftizerus ruggedaspect
