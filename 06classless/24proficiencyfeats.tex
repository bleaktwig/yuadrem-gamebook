...
\subsubsection{NAME (2 FP)} \label{feat::name}
    DESCRIPTION
    \paragraph{Requirements} Expert proficiency with gaming kits.
...
% LEATHERWORKER'S TOOLS leatherworker patchworker silencedjoints slayandskin
...
\subsubsection{Musician} \label{feat::musician}
    ...
    You add your Dexterity modifier to checks with musical instruments.
...
% NAVIGATOR'S TOOLS navigator allterrain improvisedcharter
...
% SMITH'S TOOLS blacksmith weakpoint
...
\subsubsection{NAME (2 FP)} \label{feat::name}
    DESCRIPTION % Temporarily improve a metal weapon, armor, or shield.
...
% LAND VEHICLES rider exoticrider
