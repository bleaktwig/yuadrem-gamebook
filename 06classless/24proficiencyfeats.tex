...
% BREWER'S SUPPLIES
%   - CONSTITUTION (more sampling than alchemy) : BREWS
\subsubsection{Brewer} \label{feat::brewer}
    ...
    Common brews have a DC of 8 to make, Uncommon brews a DC of 12, Rare brews a DC of 16, Very Rare a DC of 20, and legendary a DC of 24.
...
\subsubsection{NAME} \label{feat::name}
    DESCRIPTION % Double usefulness of water by purifying it
    \paragraph{Requirements} Competent proficiency with Brewer's Supplies.
\subsubsection{NAME} \label{feat::name}
    DESCRIPTION % Mask poison flavors by brewing
    \paragraph{Requirements} Skilled proficiency with Brewer's Supplies.
\subsubsection{NAME} \label{feat::name}
    DESCRIPTION - UPGRADEABLE % Enhance Ability Spell, but related to a brew. Make two tankards of the stuff per brew.
    \paragraph{Requirements} Skilled proficiency with Brewer's Supplies.
\subsubsection{NAME (2 FP)} \label{feat::name}
    DESCRIPTION % Mixing brews to sum effects
...
\subsubsection{NAME} \label{feat::name}
    DESCRIPTION % Flasks are extra special, with some boost to the brew or potion in it.
