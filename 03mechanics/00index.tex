...
\begin{DndComment}[float=h]{Help Wanted!}
    ...
    If this is the case, many other mechanics need to be changed accordingly to accommodate this.

    If for some insane reason you want to take on this challenge, you are encouraged to contact the book's author.
    We could work together on this, discussing appropriate retribution and co-authorship terms.
\end{DndComment}
