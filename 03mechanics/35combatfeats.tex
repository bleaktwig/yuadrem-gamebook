...
\begin{DndTable}[width=\linewidth, header=Martial Weapons]{ll}
    ...
    Rapiers         & \textbf{Appropriate Response} (page \pageref{feat::appropriateresponse}) \\
    ...
    Straight Swords & \textbf{Parrying Stance} (page \pageref{feat::parryingstance}) \\
...
\subsubsection{Appropriate Response (2 FP)} \label{feat::appropriateresponse}
...
\subsubsection{Bullseye} \label{feat::bullseye}
    ...
    \begin{itemize}
        ...
        \item \textbf{Hand Shot.} The creature has disadvantage on the first melee attack roll it makes during its next turn.
...
\subsubsection{Bulwark Training} \label{feat::bulwarktraining}
    You halve the movement debuff associated to heavy shields.
...
\subsubsection{Deflection} \label{feat::deflection}
    Whenever you are hit by an attack roll or an effect targeting only you that forces you to make a Dexterity saving throw, you can use your reaction to add your Strength or Dexterity modifier (your choice) to your AC or to the saving throw roll.
...
\subsubsection{Mashed Brain} \label{feat::mashedbrain}
    ...
    \paragraph{Requirements} Competent proficiency with Hammers.
\subsubsection{Snatcher} \label{feat::snatcher}
...
\subsubsection{Revenant Blade} \label{feat::revenantblade}
    All straight swords have the finesse property when you wield them.
    \paragraph{Requirements} Competent proficiency with Straight Swords.
