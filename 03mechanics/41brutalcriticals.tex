...
\subsubsection{Damage Charts}
    ...
    \begin{tikzpicture}[remember picture,overlay]
        \node[anchor=south east, xshift=0.10cm, yshift=-0.10cm] at (current page.south east) {\includegraphics[width=0.5\pdfpagewidth]{03mechanics/img/41friendlyillhevi.png}};
    \end{tikzpicture}
    ...
    \pagebreak~
    \begin{tikzpicture}[remember picture,overlay]
        \node[anchor=north, yshift=0.10cm] at (current page.north) {\includegraphics[width=\pdfpagewidth]{03mechanics/img/41arastas_domain.png}};
    \end{tikzpicture}
