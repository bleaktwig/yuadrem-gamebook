...
\begin{DndTable}[width=\linewidth, header=Doctrines Feat List]{ll}
    ...
    Sympathy 1                  & \textbf{Forced Detachment}      (page \pageref{feat::forceddetachment})      \\
...
\begin{DndTable}[width=\linewidth, header=Schools Feat List]{ll}
    ...
    Warchanting                 & \textbf{Cosmic Savagery}        (page \pageref{feat::cosmicsavagery})        \\
...
\subsubsection{Cosmic Savagery} \label{feat::cosmicsavagery}
...
\subsubsection{Fogs of Nuagal} \label{feat::fogsofnuagal}
    ...
    \paragraph{Requirements} Doctrine: Alchemy.
\subsubsection{Forced Detachment} \label{feat::forceddetachment}
...
\subsubsection{Infused Vials} \label{feat::infusedvials}
    ...
    Whenever the vial is opened by any means, the spell is cast on it as if you had cast it.
...
\subsubsection{Slippery Surface} \label{feat::slipperysurface}
    As an action, you can choose to consume a number of indigo alignment points of your choice to exude a slippery liquid from your zuan.
