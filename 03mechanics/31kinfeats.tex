...
\begin{DndTable}[width=\linewidth, header=Kin Feat List 1/3]{ll}
    ...
    Oth           & \textbf{Predestined} (page \pageref{feat::predestined})          \\
...
\begin{DndTable}[width=\linewidth, header=Kin Feat List 2/3]{ll}
    ...
    Gannagian Tsanek & \textbf{Narcotic Empowerment} (page \pageref{feat::narcoticempowerment})   \\
...
\subsubsection{Balm of Dreams} \label{feat::balmofdreams}
    ...
    This balm is ineffective on tsaneks.
...
\subsubsection{Cellular Regeneration} \label{feat::cellularregeneration}
    ...
    If you suffer cold, fire, or necrotic damage, this regeneration is canceled.
...
\subsubsection{Gat Resilience (2 FP)} \label{feat::gatresilience}
    The horned kin possesses an almost otherworldly hardiness.
...
\subsubsection{Mycelium Connection} \label{feat::myceliumconnection}
    ...
    \paragraph{Requirements} Tsanek kin.
% N
\subsubsection{Narcotic Empowerment} \label{feat::narcoticempowerment}
...
\subsubsection{Predestined} \label{feat::predestined}
...
\subsubsection{Shadow Touched} \label{feat::shadowtouched}
    You learn the invisibility (see page \pageref{spell::invisibility}) spell.
    Once you cast the spells in this way, you can't cast it in this way again until you finish a short rest.
...
\subsubsection{Third Weapon (2 FP)} \label{feat::thirdweapon}
    ...
    You can attack with this weapon as a free action after you make a melee weapon attack, reducing the attack roll by the appropiate multiple attack penalty.
    \paragraph{Requirements} Oth kin.
