...
\begin{tikzpicture}[remember picture,overlay]
    \node[anchor=south east, xshift=0.10cm, yshift=-0.10cm] at (current page.south east) {\includegraphics[width=0.50\pdfpagewidth]{05background/img/20treb_gat}};
\end{tikzpicture}
...
% \thispagestyle{empty}
% \begin{tikzpicture}[remember picture,overlay]
%     \node[anchor=south west, xshift=-0.10cm, yshift=-0.10cm] at (current page.south west) {\includegraphics[width=0.52\pdfpagewidth]{05background/img/20tortle_mycolomancer}};
% \end{tikzpicture}
