% !TEX root = ../main.tex
\section{Sympathy} \label{sec::sympathy} % Red tide, fire, explode
...
\subsection*{Flamespeaking} \label{ssec::flamespeaking} % Flamespeaking
...
\subsection*{Frithbinding} \label{ssec::frithbinding} % Eljur
...
\subsection*{Skycalling} \label{ssec::skycalling} % Queish
