...
\section*{Materials and Labor} \label{sec::materialsandlabor}
    ...
    Depending on their composition, different items require different artisans.
    This is signaled in the \textbf{Tools} section in each table.
    % The available toolsets are:

    % \begin{DndTable}[width=\linewidth, header=Toolsets]{lXlX}
    %     \textbf{Acronym} & \textbf{Toolset}      & \textbf{Acronym} & \textbf{Toolset}      \\
    %     ALC              & Alchemist's Supplies  & BRE              & Brewer's Supplies     \\
    %     CAL              & Calligrapher Supplies & CAR              & Carpenter's Tools     \\
    %     ---              & Cartographer's Tools  & COB              & Cobbler's Tools       \\
    %     COO              & Cook's Utensils       & GLA              & Glassblower's Tools   \\
    %     JEW              & Jeweler's Tools       & LEA              & Leatherworker's Tools \\
    %     MAS              & Mason's Tools         & ---              & Navigator's Tools     \\
    %     PAI              & Painter's Supplies    & POT              & Potter's Tools        \\
    %     SMI              & Smith's Tools         & ---              & Thieves' Tools        \\
    %     TIN              & Tinker's Tools        & WEA              & Weaver's Tools        \\
