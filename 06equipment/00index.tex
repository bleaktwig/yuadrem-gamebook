...
\subparagraph{Great} This weapon requires the Great Weapon User 1 talent to use.
...
\subparagraph{Trick} This weapon requires the Flexible Fighter 1 talent to use.
